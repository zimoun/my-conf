...
-- myhour = wibox.widget.textbox()
-- mytimer = timer({ timeout = 30 })
-- mytimer:connect_signal("timeout", function() myhour:set_text("Hello awesome world!") end)
-- mytimer:connect_signal("timeout", function() myhour:set_text("Ch( " .. execute_command("TZ='America/Santiago' date +%H:%M") .. " )" ) end)
-- mytimer:start()
-- require('hours')
-- hours.start_other('Fr')
...
globalkeys = awful.util.table.join(
 ...
 awful.key({ }, "XF86AudioLowerVolume", function ()
    ...
    -- Menubar
    awful.key({ modkey, "Control" }, "h", function() menubar.show() end)

    -- Remember key kinding
...
awful.rules.rules = {
    ...
    { rule = { class = "Firefox" },
       properties = { tag = tags[1][9] } },
        { rule = { class = "Skype" },
      properties = { tag = tags[1][9] } },
-- Since trademark issues are done, Iceweasel is gone and Firefox back!
