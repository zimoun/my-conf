...
(setq auto-mode-alist (cl-remove-if '(lambda (x) (equal (car x) "\\.geo\\'")) auto-mode-alist))
...
(defvar gmsh/getdp-keywords-list
  '("For" "EndFor" "If" "EndIf" "Else" "Include"
...
(defvar gmsh-keywords-list
  '("Return" "Call" "Exit"
    ...
    "Point" "Physical" "Line" "Loop" "Surface" "Volume" "Compound" "Plane" "Ruled"
